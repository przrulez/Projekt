...
<?php echo $this->Form->create('CategoriesMovie'); ?>
	<fieldset>
		<legend><?php echo __('Edit Categories Movie'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CategoriesMovie.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CategoriesMovie.id'))); ?></li>
